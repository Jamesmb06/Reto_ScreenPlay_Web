...
public class ProcesoCompra extends PageObject {
    ...
    public static final Target ITEM2 = Target.the("item2").located(By.xpath("(//button[@title='Añadir al carrito'])[3]"));
    public static final Target ITEM3 = Target.the("item3").located(By.xpath("(//button[@title='Añadir al carrito'])[4]"));
